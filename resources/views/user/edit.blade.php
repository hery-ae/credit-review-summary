					...
					<main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Edit / Users
                            </h1>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
...
@if ($user->userRoles->where('role_id', $value->id)->has($key))
														<option class="text-capitalize" value="{{ $value->id }}" selected>
                                                            {{ $value->name }}
                                                        </option>
@else
...
@if ($user->userSegmentations->where('segmentation_id', $value->id)->has($key))
														<option class="text-capitalize" value="{{ $value->id }}" selected>
                                                            {{ $value->name }}
                                                        </option>
@else
